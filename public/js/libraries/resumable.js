...
(function() {
    ...
    var Resumable = function(opts) {
        ...
        $.defaults = {
            ...
            query: {}, //Extra parameters to include in the multipart request with data. This can be an object or a function. If a function, it will be passed a ResumableFile and a ResumableChunk object (
            headers: {},
            preprocess: null,
            method: 'multipart',
            uploadMethod: 'POST', //http req when sending chunks to server
            testMethod: 'GET',
        ...
        $.updateTargetURL = (newUrl) => {
            ...
            console.log('changing upload target url')
            $.opts.target = newUrl;
        ...
        $.updateFilesIDs = (files) => {
            console.log('returning files in resumable');
            console.log($);
        ...
        var $h = {
            ...
            generateUniqueIdentifier: function(file, event) {
                ...
                return (idSeed + '-' + size + '-' + relativePath /*.replace(/[^0-9a-zA-Z_-]/img, '')*/ );
            },
